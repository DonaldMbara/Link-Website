...
window.$ = $;
var fs = require('fs');
var jqueryT = fs.readFileSync('Link Website/js/profession.js'); //this imports the file i want to test

var html = fs.readFileSync('Link Website/html/profession.html','utf-8');
describe('validateSubmits', function() {
    it('shows/hides error banner', function() {
        question = require('./profession.js'); //this imports the file i want to test
...
describe('vals', function(){
    const { sum, positive, negative } = require('./profession');
    let vals;
    let sum_of_vals;
    let pos_vals;
    let neg_vals;
